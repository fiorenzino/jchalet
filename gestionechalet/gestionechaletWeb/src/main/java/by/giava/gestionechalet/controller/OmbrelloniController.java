...
public class OmbrelloniController extends AbstractLazyController<Ombrellone> {
	...
	@ListPage
	public static final String LIST = "/ombrelloni/lista.xhtml";

	@EditPage
	public static final String EDIT = "/ombrelloni/gestione.xhtml";

	@ViewPage
	public static final String VIEW = "/ombrelloni/scheda.xhtml";
